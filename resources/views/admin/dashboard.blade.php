					...
					<div class="list-group list-group-flush">
						...
						<div class="list-group-item">
							...
							<div class="list-group-item-figure">
								<a href="user-profile.html" class="user-avatar" data-toggle="tooltip" title="Martha Myers"><img src="https://uselooper.com/assets/images/avatars/uifaces16.jpg" alt=""></a>
							</div>
							<!-- /.list-group-item-figure -->
						...
						<div class="list-group-item">
							<!-- .list-group-item-figure -->
							<div class="list-group-item-figure">
								<a href="user-profile.html" class="user-avatar" data-toggle="tooltip" title="Tammy Beck"><img src="https://uselooper.com/assets/images/avatars/uifaces15.jpg" alt=""></a>
							</div>
							<!-- /.list-group-item-figure -->
							<!-- .list-group-item-body -->
							<div class="list-group-item-body">
						...
						<div class="list-group-item">
							<!-- .list-group-item-figure -->
							<div class="list-group-item-figure">
								<a href="user-profile.html" class="user-avatar" data-toggle="tooltip" title="Susan Kelley"><img src="https://uselooper.com/assets/images/avatars/uifaces17.jpg" alt=""></a>
							</div>
							<!-- /.list-group-item-figure -->
							<!-- .list-group-item-body -->
							<div class="list-group-item-body">
						...
						<div class="list-group-item">
							<!-- .list-group-item-figure -->
							<div class="list-group-item-figure">
								<a href="user-profile.html" class="user-avatar" data-toggle="tooltip" title="Albert Newman"><img src="https://uselooper.com/assets/images/avatars/uifaces18.jpg" alt=""></a>
							</div>
							<!-- /.list-group-item-figure -->
							<!-- .list-group-item-body -->
							<div class="list-group-item-body">
						...
						<div class="list-group-item">
							<!-- .list-group-item-figure -->
							<div class="list-group-item-figure">
								<a href="user-profile.html" class="user-avatar" data-toggle="tooltip" title="Kyle Grant"><img src="https://uselooper.com/assets/images/avatars/uifaces19.jpg" alt=""></a>
							</div>
							<!-- /.list-group-item-figure -->
							<!-- .list-group-item-body -->
							<div class="list-group-item-body">
			...
			<div class="card card-fluid pb-3">
				...
				<div class="lits-group list-group-flush">
					...
					<div class="list-group-item">
						...
						<div class="list-group-item-figure">
							<div class="has-badge">
								<a href="page-project.html" class="tile tile-md bg-purple">LT</a> <a href="#team" class="user-avatar user-avatar-xs"><img src="https://uselooper.com/assets/images/avatars/team4.jpg" alt=""></a>
							</div>
						</div>
						<!-- /.lits-group-item-figure -->
					...
					<div class="list-group-item">
						...
						<div class="list-group-item-figure">
							<div class="has-badge">
								<a href="page-project.html" class="tile tile-md bg-indigo">SP</a> <a href="#team" class="user-avatar user-avatar-xs"><img src="https://uselooper.com/assets/images/avatars/team1.jpg" alt=""></a>
							</div>
						</div>
						<!-- /.lits-group-item-figure -->
						<!-- .lits-group-item-body -->
					...
					<div class="list-group-item">
						...
						<div class="list-group-item-figure">
							<div class="has-badge">
								<a href="page-project.html" class="tile tile-md bg-yellow">OS</a> <a href="#team" class="user-avatar user-avatar-xs"><img src="https://uselooper.com/assets/images/avatars/team2.png" alt=""></a>
							</div>
						</div>
						<!-- /.lits-group-item-figure -->
						<!-- .lits-group-item-body -->
					...
					<div class="list-group-item">
						...
						<div class="list-group-item-figure">
							<div class="has-badge">
								<a href="page-project.html" class="tile tile-md bg-blue">BA</a> <a href="#team" class="user-avatar user-avatar-xs"><img src="https://uselooper.com/assets/images/avatars/bootstrap.svg" alt=""></a>
							</div>
						</div>
						<!-- /.lits-group-item-figure -->
						<!-- .lits-group-item-body -->
					...
					<div class="list-group-item">
						...
						<div class="list-group-item-figure">
							<div class="has-badge">
								<a href="page-project.html" class="tile tile-md bg-teal">SB</a> <a href="#team" class="user-avatar user-avatar-xs"><img src="https://uselooper.com/assets/images/avatars/sketch.svg" alt=""></a>
							</div>
						</div>
						<!-- /.lits-group-item-figure -->
						<!-- .lits-group-item-body -->
					...
					<div class="list-group-item">
						...
						<div class="list-group-item-figure">
							<div class="has-badge">
								<a href="page-project.html" class="tile tile-md bg-pink">SP</a> <a href="#team" class="user-avatar user-avatar-xs"><img src="https://uselooper.com/assets/images/avatars/team4.jpg" alt=""></a>
							</div>
						</div>
						<!-- /.lits-group-item-figure -->
						<!-- .lits-group-item-body -->
...
@section('script')
	<!-- BEGIN PLUGINS JS -->
    <script src="{{ URL::to('assets/pace-progress/pace.min.js') }}"></script>
    <script src="{{ URL::to('assets/stacked-menu/js/stacked-menu.min.js') }}"></script>
    <script src="{{ URL::to('assets/perfect-scrollbar/perfect-scrollbar.min.js') }}"></script>
    <script src="{{ URL::to('assets/flatpickr/flatpickr.min.js') }}"></script>
    <script src="{{ URL::to('assets/easy-pie-chart/jquery.easypiechart.min.js') }}"></script>
