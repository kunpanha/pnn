...
@section('content')
        ...
        <form class="auth-form" method="post" action="{{ route('password.update') }}">
            ...
            <div class="form-group">
                <div class="form-label-group">
                    <input type="email" name="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="Email" value="{{ old('email', $request->email) }}"> <label for="Email">Email</label>
            ...
            <div class="form-group">
                <div class="form-label-group">
                    <input type="password" name="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="Password"> <label for="Password">Password</label>
            ...
            <div class="form-group">
                <div class="form-label-group">
                    <input type="password" name="password_confirmation" class="form-control{{ $errors->has('password_confirmation') ? ' is-invalid' : '' }}" placeholder="Password"> <label for="Confirm Password">Confirm Password</label>
    ...
    <!-- /form -->
    <!-- copyright -->
    <footer class="auth-footer"> © 2021 All Rights Reserved. <a href="#">Privacy</a> and <a href="#">Terms</a></footer>
    <!-- /copyright -->
@endsection