...
@section('title', 'ភាពយន្តភាគចិន')

@section('meta')
	<link rel="canonical" href="{{ route('chinese') }}">
@endsection

@section('style')
	<!-- Pages CSS -->
    <link rel="stylesheet" href="{{ URL::to('assets/pages/css/pages/drama_chinese.css') }}" type="text/css" media="screen" />
@endsection
