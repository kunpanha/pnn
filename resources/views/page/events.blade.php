...
@section('style')
	<!-- Pages CSS -->
    <link rel="stylesheet" href="{{ URL::to('assets/pages/css/pages/events.css') }}" type="text/css" media="screen" />
@endsection
                ...
                <div class="col-xs-12">
                    <div id="sect-top">
                        <div class="section-title">
                            <a href="javascript:void(0)" class="cursor-auto"><h2>ព្រឹត្តិការណ៍</h2></a>
                        </div>
                    </div>
                </div>
            </div>
